    ...
    <section class="section">
    	<div class="row"><div class="col-lg-5">
	          ...
	          <div class="card"><div class="card-body">
	              ...
	              <form>
	                <div class="row mb-3">
	                  <label for="inputText" class="col-sm-2 col-form-label">업체명</label>
	                  <div class="col-sm-10">
	                ...
	                <div class="row mb-3">
	                  ...
	                  <div class="col-sm-5">
	                   ...
	                   <div class="col-sm-5">
	                    <button class="btn btn-secondary">중복검사</button>
	                  </div>
	                </div>
	                <div class="row mb-3">
	                ...
	                <div class="row mb-3">
	                  ...
	                  <div class="col-sm-5">
						...
						<input type="text" id="basicAddress" placeholder="주소" class="form-control">
